...
import com.wyl.zodiac.core.constant.ExcelConstants;
 ...
 * @version V1.0
 * @Title: ExcelUtils
 * @Package com.wyl.aquarius.util
 * @Description:
 * @date 2017/11/17 15:14
 */
public class ExcelUtils {
    static Logger logger = LoggerFactory.getLogger(com.wyl.zodiac.core.util.ExcelUtils.class);
